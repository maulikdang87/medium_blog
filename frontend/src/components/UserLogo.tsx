...
const UserLogo = ({name , email } : { name : string , email : string}) => {
    ...
    return (
            ...
            <div
              id="dropdownAvatar"
              className="fixed z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44"
            >
...
export const Spinner = ()=> {
    return (
            <div>
                <div role="status">
                    <svg aria-hidden="true" className="w-8 h-8 text-gray-200 animate-spin fill-gray-900" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
