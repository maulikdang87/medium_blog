            ...
            <div className='flex flex-col'>
                ...
                <div className=' flex justify-center p-4'>
                    ...
                    {posts.map((post) => <div className="">
                        ...
                        <button type="button" className="focus:outline-none text-white bg-green-600 hover:bg-green-800 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2" onClick={()=> {
